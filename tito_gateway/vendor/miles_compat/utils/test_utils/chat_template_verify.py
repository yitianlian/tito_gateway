...
from tito_gateway.vendor.miles_compat.utils.chat_template_utils.template import apply_chat_template_from_str

if TYPE_CHECKING:
    from tito_gateway.vendor.miles_compat.utils.chat_template_utils.tito_tokenizer import TITOTokenizer, TITOTokenizerType
...
from tito_gateway.vendor.miles_compat.utils.test_utils.mock_trajectories import (  # noqa: E402
